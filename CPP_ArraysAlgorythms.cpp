...
{
	setlocale(LC_ALL, "ru");
	cout << "Алгоритмы работы с одномерными массивами: линейный и бинарный поиск, сортировки и т.д." << endl << endl << "--------------------------------------------------------------------------------------------------" << endl;
	const int N = 20;
	int array[N];
	...
	// Сортировка массива поиском (выбором) минимального (selection sort)
	int imin = 0, temp;
	n = 0;
